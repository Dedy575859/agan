...
echo color("red","|SCRIPT GOPUT| \n");
echo color("red","|BY : JURAGAN | \n");
echo color("red","|SPECIAL LEBARAN COVID |\n");
echo color("white","|Time  : ".date('[d-m-Y] [H:i:s]|')."   \n");
echo color("white","|DAFTAR DENGAN AWALAN 62xnxxx| \n");
echo color("white","LANGSUNG GASKEUN!!! \n");
function change(){
        $nama = nama();
        ...
        $expired6 = getStr1('"expiry_date":"','"',$cekvoucher,'6');
         ...
         echo color("red","NOMER MU UDAH KEDAFTAR /SALAH !!!");
         echo "\nMau ulang? (y/n): ";
